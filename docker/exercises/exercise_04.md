...
1. Deploy the Latest Version (```latest```)

```
docker run -d -p 8080:80 --name mediawiki1 mediawiki
```

Access ```http://localhost:8080``` and verify that you have installed version `1.42.3`.

<img width="1468" alt="Screenshot 2024-10-20 at 7 40 00 PM" src="https://github.com/user-attachments/assets/2aca36ad-3a52-4799-ab77-2214625e44b9">


2. Deploy an Older Version (```1.39.5```)
...
<img width="1461" alt="Screenshot 2024-10-20 at 7 36 36 PM" src="https://github.com/user-attachments/assets/c6e14c87-ec73-497e-ac60-02acfa116dbc">


3. Deploy Another Older Version (```1.38.6```)
...
<img width="1464" alt="Screenshot 2024-10-20 at 7 37 57 PM" src="https://github.com/user-attachments/assets/d9075eae-2b1b-4d85-a9dc-fe71f241656b">
